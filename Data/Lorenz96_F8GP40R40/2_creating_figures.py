...
# plt.plot(energy)
# plt.savefig(save_path + "/Figures/energy.pdf", bbox_inches="tight")
# plt.close()

plt.plot(energy)
plt.title("Cummulative energy of Lorenz 96 with F=8")
plt.plot(np.linspace(1,35,len(energy)), np.ones_like(energy)*energy[34], '--r', label=r"98.4 \%", linewidth=2)
