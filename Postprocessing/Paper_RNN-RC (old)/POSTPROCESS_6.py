...
# python3 POSTPROCESS_6.py --system_name Lorenz3D
...
val_results_path = global_params.saving_path.format(system_name) + global_params.results_dir
train_results_path = global_params.saving_path.format(system_name) + global_params.model_dir
