    ...
    for r in range(len(RDIM_VALUES)):
        ...
        for xlim in xlims:
            for ylim in ylims:
                ...
                fig.savefig(fig_path + '/RMNSE_BBO_{:}_2_M_RDIM_{:}_{:}_{:}.pdf'.format(NUM_ACC_PRED_STR_SHORT, RDIM, int(1000*xlim), int(1000*ylim)), bbox_inches='tight')
                plt.close()
        ...
        for xlim in xlims:
            for ylim in ylims:
                ...
                NUM_ACC_PRED_STR_SHORT = "NAP" if NUM_ACC_PRED_STR =="num_accurate_pred_050_avg_TEST" else 0
                fig.savefig(fig_path + '/RMNSE_BBO_{:}_2_M_RDIM_{:}_{:}_{:}_LEGEND.pdf'.format(NUM_ACC_PRED_STR_SHORT, RDIM, int(1000*xlim), int(1000*ylim)), bbox_extra_artists=(lgd,), bbox_inches='tight')
                plt.close()
