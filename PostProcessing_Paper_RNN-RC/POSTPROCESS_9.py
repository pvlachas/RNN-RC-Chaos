...
# python3 POSTPROCESS_9.py --system_name Lorenz3D
# python3 POSTPROCESS_9.py --system_name Lorenz96_F8GP40R40
    ...
    for MODEL in range(len(model_names_str)):
        ...
        for xlim in xlims:
            for ylim in ylims:
                ...
                fig.savefig(fig_path + '/LOG_RMNSE_BBO_{:}_2_RDIM_{:}_{:}.pdf'.format(NUM_ACC_PRED_STR_SHORT, model_label_str[MODEL], bounds_iter), bbox_inches='tight')
                plt.close()
        ...
        for xlim in xlims:
            for ylim in ylims:
                ...
                NUM_ACC_PRED_STR_SHORT = "NAP" if NUM_ACC_PRED_STR =="num_accurate_pred_050_avg_TEST" else 0
                fig.savefig(fig_path + '/LOG_RMNSE_BBO_{:}_2_RDIM_{:}_{:}_LEGEND.pdf'.format(NUM_ACC_PRED_STR_SHORT, model_label_str[MODEL], bounds_iter), bbox_inches='tight')
                plt.close()
                bounds_iter = bounds_iter + 1
